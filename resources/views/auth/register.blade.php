                    ...
                    <div class="card card-plain">
                        ...
                        <div class="card-body">
                            <form role="form">
                                ...
                                <div class="text-center">
                                    <button type="submit" class="btn btn-lg bg-gradient-custom btn-lg w-100 mt-4 mb-0">Sign up</button>
                                </div>
                            </form>
                        </div>
                        <div class="card-footer text-center pt-0 px-lg-2 px-1">
                            <p class="mb-4 text-sm mx-auto">
                                ...
                                <a href="{{Route('login')}}" class="text-custom text-gradient font-weight-bold">Log in</a>
                            </p>
                        </div>
                    </div>
                </div>
