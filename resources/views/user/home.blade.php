        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-7 text-center mx-auto">
                    <p class="lead text-white pb-3 mt-3">Selamat Datang.</p>
                    <h1 class="text-white pt-3 mt-n5">Sertifikat Training Online</h1>
                    ...
                    <a class="btn" href="{{Route('dashboard')}}" style="background-color:#82b440; box-shadow: 0 2px 0 #6f9a37;font-size: 16px; color: #fff; width:200px;">Start</a>
                </div>
            </div>
        </div>
