...
<head>
	...
	<meta http-equiv="X-UA-Compatible" content="IE=edge">
  	...
  	<!-- ::::::::::::::Favicon icon::::::::::::::-->
  	<link rel="shortcut icon" href="{{asset('layouts/admin-layout/asset/logo/logo freshmart.png')}}" type="image/png">
	<link href="{{asset('layouts/admin-layout/vendor/owl-carousel/owl.carousel.css')}}" rel="stylesheet">
	<link href="{{asset('layouts/admin-layout/vendor/bootstrap-select/dist/css/bootstrap-select.min.css')}}" rel="stylesheet">
  	<link href="{{asset('layouts/admin-layout/css/admin/style.css')}}" rel="stylesheet">
...
<body>
              			...
              			<li class="nav-item dropdown header-profile">
							<a class="nav-link" href="javascript:;" role="button" data-toggle="dropdown">
								...
								<div class="header-info">
									<span>Hello,<strong> helo</strong></span>
								</div>
							</a>
    ...
    <!-- END Section Content -->
  	...
  	<!-- Scripts -->
  	<!-- Required vendors -->
  	<script src="{{asset('layouts/admin-layout/vendor/global/global.min.js')}}"></script>
	<script src="{{asset('layouts/admin-layout/vendor/bootstrap-select/dist/js/bootstrap-select.min.js')}}"></script>
	<script src="{{asset('layouts/admin-layout/vendor/chart.js/Chart.bundle.min.js')}}"></script>
  	<script src="{{asset('layouts/admin-layout/js/admin/custom.min.js')}}"></script>
	<script src="{{asset('layouts/admin-layout/js/admin/deznav-init.js')}}"></script>
	<script src="{{asset('layouts/admin-layout/vendor/owl-carousel/owl.carousel.js')}}"></script>
	
	<!-- Apex Chart -->
	<script src="{{asset('layouts/admin-layout/vendor/apexchart/apexchart.js')}}"></script>
	
	<!-- Dashboard 1 -->
	<script src="{{asset('layouts/admin-layout/js/admin/dashboard/dashboard-1.js')}}"></script>
	<script>
